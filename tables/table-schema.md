...
| 传统主结果 | benchmark × 4 classical methods | seed 42 Accuracy/F1/AUROC/Human FPR | results/summary/main_results.md | 已完成 |
| 深度消融 | Style-LR/Encoder/Encoder+Style | seed 42 Accuracy/F1/AUROC/Human FPR | results/summary/ablation_results.md | 已完成 |
| 鲁棒性 | benchmark/method/attack | seed 42 F1/AUROC/Human FPR and delta | results/summary/robustness_results.md | 已完成 |
